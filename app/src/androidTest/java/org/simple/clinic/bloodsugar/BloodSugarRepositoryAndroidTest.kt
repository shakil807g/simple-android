...
class BloodSugarRepositoryAndroidTest {
  ...
  fun saving_a_blood_sugar_reading_should_work_correctly() {
    ...
    val bloodSugarReading = BloodSugarReading(value = 50.toFloat(), type = Random)
  ...
  fun updating_a_blood_sugar_should_update_it_correctly() {
    ...
    val bloodSugarReading = BloodSugarReading(126.toFloat(), Random)
    ...
    repository.updateMeasurement(bloodSugar.copy(reading = bloodSugarReading.copy(value = 145.toFloat())))

    // then
    val expected = bloodSugar.copy(
        reading = bloodSugarReading.copy(145.toFloat()),
